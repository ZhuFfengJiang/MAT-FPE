...
def parse_args():
    ...
    # Image size
    parser.add_argument('-size', '--img_size', default=960, type=int,
    ...
    # Batchsize
    parser.add_argument('-bs', '--batch_size', default=18, type=int, 
    ...
    # Dataset
    parser.add_argument('--root', default='./data/mycoco',
                        help='data root')
    ...
    parser.add_argument('--ema', action='store_true', default=False,
                        help='Model EMA')
    parser.add_argument('--min_box_size', default=0.0, type=float,
    ...
    # DDP train
    parser.add_argument('-dist', '--distributed', action='store_true', default=True,
